...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Master Categories</h1>
        <a href="{{ url('categories/create') }}" class="btn btn-primary btn-square btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between">
                                                    <a class="btn btn-info btn-sm" href="{{ url('/categories') }}/{{ $item['id'] }}/edit">edit</a>
