...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Material Qty Manager</h1>
        <a href="{{ url('qty-manager/create') }}" class="btn btn-primary btn-square btn-sm">
            Create New Entry Inward/Outward
        </a>
    </div>
